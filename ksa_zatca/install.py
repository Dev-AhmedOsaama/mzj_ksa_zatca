...
def make_custom_fields():
	...
	tax_rate = dict(fieldname='tax_rate', label='Tax Rate',
		fieldtype='Float', insert_after='item_tax_template', read_only=1)
 
	tax_amount = dict(fieldname='tax_amount', label='Tax Amount',
		fieldtype='Float', insert_after='tax_rate', read_only=1)
 
	total_amount = dict(fieldname='total_amount', label='Total Amount',
		fieldtype='Float', insert_after='tax_amount', read_only=1)
